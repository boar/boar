...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Ceremony.end_date'
        db.add_column('awards_ceremony', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Ceremony.end_date'
        db.delete_column('awards_ceremony', 'end_date')
