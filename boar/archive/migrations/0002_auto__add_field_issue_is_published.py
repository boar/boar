...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('archive_issue', 'is_published', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Issue.is_published'
        db.delete_column('archive_issue', 'is_published')
