...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PodcastMetadata.size'
        db.add_column('articles_podcastmetadata', 'size', models.IntegerField(default=0))
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'PodcastMetadata.size'
        db.delete_column('articles_podcastmetadata', 'size')
