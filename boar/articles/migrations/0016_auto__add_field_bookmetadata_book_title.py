...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BookMetadata.book_title'
        db.add_column('articles_bookmetadata', 'book_title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'BookMetadata.book_title'
        db.delete_column('articles_bookmetadata', 'book_title')
