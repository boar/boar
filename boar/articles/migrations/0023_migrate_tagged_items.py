...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for item in orm['tagging.taggeditem'].objects.select_related('tag'):
            try:
                article = orm['articles.article'].objects.get(id=item.object_id)
            except orm['articles.article'].DoesNotExist:
                continue
            orm['articles.taggedarticle'].objects.create(
                tag=orm['articles.tag'].objects.get(slug=item.tag.slug),
    ...
    models = {
        ...
        'articles.topicmetadata': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['uploads.Image']", 'null': 'True', 'blank': 'True'}),
            'topic': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'metadata'", 'unique': 'True', 'to': "orm['articles.Tag']"})
        },
    ...
    complete_apps = ['tagging', 'articles']
