...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_article', 'page', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['archive.Page'], null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Article.page'
        db.delete_column('articles_article', 'page_id')
    ...
    models = {
        ...
        'articles.article': {
            ...
            'page': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['archive.Page']", 'null': 'True', 'blank': 'True'}),
