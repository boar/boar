...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('articles_tag', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table('articles_topicmetadata', (
            ('topic', self.gf('django.db.models.fields.related.OneToOneField')(related_name='metadata', unique=True, to=orm['articles.Tag'])),
        ...
        db.delete_column('articles_tag', 'description')
