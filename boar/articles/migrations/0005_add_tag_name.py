...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Section.tag_name'
        db.add_column('articles_section', 'tag_name', models.CharField(default='Topics', max_length=100))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Section.tag_name'
        db.delete_column('articles_section', 'tag_name')
