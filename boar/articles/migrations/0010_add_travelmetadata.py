...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.create_table('articles_travelmetadata', (
            ...
            ('article', models.OneToOneField(orm.Article, related_name='travel_metadata', unique=True)),
    ...
    models = {
        ...
        'articles.travelmetadata': {
            'article': ('models.OneToOneField', ["orm['articles.Article']"], {'related_name': "'travel_metadata'", 'unique': 'True'}),
            'id': ('models.AutoField', [], {'primary_key': 'True'}),
            'location': ('models.PointField', [], {})
        },
        'articles.section': {
