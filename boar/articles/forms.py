...
from boar.articles.widgets import AutoCompleteTagInput, MarkItUpWidget
...
class ArticleAdminModelForm(forms.ModelForm):
    ...
    tags = TagField(widget=AutoCompleteTagInput(), required=False, help_text=Article._meta.get_field('tags').help_text)
