...
class Migration:
    ...
    def backwards(self, orm):
        ...
        db.create_table('uploads_audio', (
            ('upload_date', orm['uploads.audio:upload_date']),
            ('title', orm['uploads.audio:title']),
            ('author', orm['uploads.audio:author']),
            ('upload', orm['uploads.audio:upload']),
            ('id', orm['uploads.audio:id']),
        ))
